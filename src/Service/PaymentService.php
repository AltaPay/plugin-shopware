...
class PaymentService extends AbstractPaymentHandler
{
    ...
    /**
     * AltaPay official outgoing IP addresses used for callback validation.
     * Source: AltaPay documentation.
     * This is a security requirement to prevent fraudulent callbacks.
     */
    public const ALTAPAY_IP_ADDRESS_SET = [
        '185.206.120.0/24',
        '2a10:a200::/29',
        '185.203.232.129',
        '185.203.233.129',
